  ...
  misc = {
    ...
    rnj_loc_txts = {
      conds = {
        ...
        hands_left = {
          "if #3# {C:blue}hands{} remaining at end of round"
        },
        rare = {
        ...
        discards_left = {
          "if #3# {C:red}discards{} remaining at end of round"
        },
        or_less = {
      ...
      actions = {
        make_spectral = {
          "Create {C:attention}#2#{C:spectral} Spectral{} card"
        },
        make_planet = {
          "Create {C:attention}#2#{C:planet} Planet{} card"
        },
        add_dollars = {
          "Earn {C:money}$#2#{}"
        },
        make_joker = {
          "Create {C:attention}#2# Joker{}"
        },
        make_tarot = {
          "Create {C:attention}#2#{C:tarot} Tarot{} card"
        }
      },
      stats = {
        x_mult = {
