LOVELY_INTEGRITY = '2c356ab4130ddd5a1506b6a1942c1ab7c2d82c46d6c53e829b119eaaa8ef366c'
...
function Tag:apply_to_run(_context)
    ...
    if not self.triggered and self.config.type == _context.type then
       if (_context.type == 'store_joker_create') and skill_active("sk_grm_scarce_1") then
            return
        end
