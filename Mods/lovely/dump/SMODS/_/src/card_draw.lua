LOVELY_INTEGRITY = '488a8249473dd62c54d2f1cf0933854f63a5512730c068a5a8c8a02ea7fb54c5'
...
SMODS.DrawStep {
    ...
    func = function(self, layer)
        ...
        if (self.edition and self.edition.negative and not Reverie.is_cine_or_reverie(self)) or (self.ability.name == 'Antimatter' and (self.config.center.discovered or self.bypass_discovery_center)) then
