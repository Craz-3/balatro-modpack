LOVELY_INTEGRITY = '692177b8af699422f6cbef1f0d69357792406cec18089e2203cf6fda8dd15608'
...
function Game:set_globals()
    ...
    self.STATES = {    
        ...
        NEW_ROUND = 19,
        garb_MINIGAME = 20,
        MINIGAME_TUTORIAL = 21,
        MINIGAME_OVER = 22,
        garb_SPECIAL_THANKS = 23
    }
    ...
    self.C = {
        ...
        AKYRS_REPLICANT_O = HEX("ff9a56"),
        AKYRS_REPLICANT_C = HEX("a30262"),
