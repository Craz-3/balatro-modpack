LOVELY_INTEGRITY = '0c13b21a2091dec930f4967c9f391300cb1a4e24f166831fe6a8ef09f753cd7f'
...
function Back:apply_to_run()
    ...
    if self.effect.config.discards then 
        ...
        G.GAME.starting_params.discards = math.max(G.GAME.starting_params.discards, 0)
    end
