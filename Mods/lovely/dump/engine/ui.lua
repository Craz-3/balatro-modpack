LOVELY_INTEGRITY = '90fb1dbf6c77739ae34053b22c97cfac7e29c94528a0326a7a98a4da65114f60'
...
function UIBox:calculate_xywh(node, _T, recalculate, _scale)
    ...
    if node.UIT == G.UIT.B or node.UIT == G.UIT.T or node.UIT == G.UIT.O then
        ...
        if node.UIT == G.UIT.T then
            ...
            if type(node.config.text) ~= "string" then node.config.text = tostring(node.config.text) end
