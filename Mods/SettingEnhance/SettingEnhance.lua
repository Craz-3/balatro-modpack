...
--- MOD_AUTHOR: [Ash_K]
--- MOD_DESCRIPTION: 设置增强，具体功能如下： 显示帧率 开关Shader模式（可减少GPU使用率，默认开启，会使画面变灰） 开关金手指模式(打开会减少游戏游玩体验)  调整字体大小 渲染比例 帧率限制
        ...
        return {
            ...
            nodes = {
                ...
                create_option_cycle{
                    ...
                    scale = 0.8,
                    options = { 0.2, 0.25, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.2 ,1.5 ,2.0},
                    ...
                    current_option = (
                        ...
                        G.SETTINGS.Enhance.canvScale == 1.2 and 9 or
                        G.SETTINGS.Enhance.canvScale == 1.5 and 10 or
                        G.SETTINGS.Enhance.canvScale == 2.0 and 11
                    )
                },
                {
                    n = G.UIT.R,
