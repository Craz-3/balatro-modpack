return {
    ...
    misc = {
        dictionary = {
            ...
            spell_not = "not ",
            spell_Heart = "Heart",
            spell_Diamond = "Diamond",
            spell_Club = "Club",
            spell_Spade = "Spade",
            spell_Ace = "Ace",
            spell_Face = "Face",
            spell_Numbered = "Numbered",
            k_betmma_spell_pack = "Spell Pack",
            k_betmma_smoke = "Smoke!",
            k_betmma_downgrade_ex = "Downgrade!",
            k_betmma_reflection = "Reflection!",
            k_betmma_crystal = "Crystalization!",
            k_spell_collection = "Spells",
            k_spell_name = "Spell",
            k_spell_undiscovered_name = "Not Discovered",
